...
uint32_t Board_HW_Init(void)                  //GPIO INIT
{
  ...
  GPIO_PinModeSet(PORT_PB1, PIN_PB1, InputMode, 0);
  GPIO_PinModeSet(PORT_PB2, PIN_PB2, InputMode, 0);
  GPIO_PinModeSet(PORT_PB3, PIN_PB3, InputMode, 0);
  GPIO_PinModeSet(PORT_PB4, PIN_PB4, InputMode, 0);
  GPIO_PinModeSet(PORT_PB5, PIN_PB5, InputMode, 0);
  GPIO_PinModeSet(PORT_PB6, PIN_PB6, InputMode, 0);
  GPIO_PinModeSet(PORT_PB7, PIN_PB7, InputMode, 0);
  GPIO_PinModeSet(PORT_PB8, PIN_PB8, InputMode, 0);
  //GPIO_PinModeSet(PORT_SENSOR_INT, PIN_SENSOR_INT, InputMode, 1);
