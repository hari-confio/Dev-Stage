...
#define emberAfSampleMfgSpecificCluster2DebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_SAMPLE_MFG_SPECIFIC_CLUSTER_2) ) { x; }
#define emberAfSampleMfgSpecificCluster2PrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_SAMPLE_MFG_SPECIFIC_CLUSTER_2, (buffer), (len), (withSpace))
#define emberAfSampleMfgSpecificCluster2PrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_SAMPLE_MFG_SPECIFIC_CLUSTER_2, (buffer))
#else
...
#define emberAfSlWwahClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_SL_WWAH_CLUSTER) ) { x; }
#define emberAfSlWwahClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_SL_WWAH_CLUSTER, (buffer), (len), (withSpace))
...
// Printing macros for cluster: custom end device configuration Cluster
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER)
#define emberAfCustomEndDeviceConfigurationClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER, __VA_ARGS__)
#define emberAfCustomEndDeviceConfigurationClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfCustomEndDeviceConfigurationClusterFlush()
#define emberAfCustomEndDeviceConfigurationClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER) ) { x; }
#define emberAfCustomEndDeviceConfigurationClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER, (buffer), (len), (withSpace))
#define emberAfCustomEndDeviceConfigurationClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER, (buffer))
#else
#define emberAfCustomEndDeviceConfigurationClusterPrint(...)
#define emberAfCustomEndDeviceConfigurationClusterPrintln(...)
#define emberAfCustomEndDeviceConfigurationClusterFlush()
#define emberAfCustomEndDeviceConfigurationClusterDebugExec(x)
#define emberAfCustomEndDeviceConfigurationClusterPrintBuffer(buffer, len, withSpace)
#define emberAfCustomEndDeviceConfigurationClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER)
