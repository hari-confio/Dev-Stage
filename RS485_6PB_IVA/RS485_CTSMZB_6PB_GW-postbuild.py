...
def OTA():
    if not '"%PROJECT_DIR%\..\\..\\..\\..\\..\\SiliconLabs\\SimplicityStudio\\v5\\developer\\sdks\\gecko_sdk_suite\\v3.2\\protocol\\zigbee\\tool\\image-builder\\image-builder-windows.exe" --create "%TARGET_BPATH%.ota" --version 100 --manuf-id 0x1002 --image-type 0005 --tag-id 0x0000 --tag-file "%TARGET_BPATH%.gbl" --string "EBL RS485_CTSMZB_6PB_GW"':
        sys.exit(0)
    print (" ")
    ...
    IMAGE_BUILDER = '"%PROJECT_DIR%\..\\..\\..\\..\\..\\SiliconLabs\\SimplicityStudio\\v5\\developer\\sdks\\gecko_sdk_suite\\v3.2\\protocol\\zigbee\\tool\\image-builder\\image-builder-windows.exe" --create "%TARGET_BPATH%.ota" --version 100 --manuf-id 0x1002 --image-type 0005 --tag-id 0x0000 --tag-file "%TARGET_BPATH%.gbl" --string "EBL RS485_CTSMZB_6PB_GW"'.replace("\t", "\\t")
