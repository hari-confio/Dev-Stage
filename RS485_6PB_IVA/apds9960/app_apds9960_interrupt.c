...
#include <apds9960/app_apds9960_interrupt.h>
                                ...
                                uint8_t proximity_low_threshold, uint8_t proximity_high_threshold)
{
    ...
    DRIVER_APDS9960_LINK_IIC_INIT(&gs_handle, interface_iic_init);
    ...
    res = apds9960_set_gesture_wait_time(&gs_handle, APDS9960_GESTURE_WAIT_TIME_39P2_MS/*APDS9960_INTERRUPT_DEFAULT_GESTURE_WAIT_TIME*/);
    if (res != 0)
    {
...
//	}
	...
	return gs_handle.gesture_status;
}
