...
#define BSP_BUTTON1_PIN                       (2U)
#define BSP_BUTTON1_PORT                      (gpioPortC)

#define BSP_BUTTON2_PIN                       (0U)
#define BSP_BUTTON2_PORT                      (gpioPortC)

#define BSP_BUTTON3_PIN                       (3U)
#define BSP_BUTTON3_PORT                      (gpioPortD)

#define BSP_BUTTON4_PIN                       (2U)
#define BSP_BUTTON4_PORT                      (gpioPortD)

#define BSP_BUTTON5_PIN                       (0U)
#define BSP_BUTTON5_PORT                      (gpioPortB)
...
#define HAL_BUTTON_COUNT                      (6U)
#define HAL_BUTTON_ENABLE                     { 0, 1, 2, 3, 4, 5 }
// [BUTTON]$
...
#define HAL_PA_SELECTION                      (HAL_PA_SELECTION_HIGHEST)
// [PA]$
