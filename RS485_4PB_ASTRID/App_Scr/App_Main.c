...
for(int i=0; i<8; i++)
  {
    if(Rx_Buff[i] == MACID[i])
      {
        mac_match_cnt++;
        if(mac_match_cnt == 7 && Rx_Buff[8] == 0x04) //4pb
          {
            // Proceed for further processing
            if(Rx_Buff[9] == 0x01) //BTN-1, 3
              {
...
//                  set_led(3, Rx_Buff[11]);
            ...
            //0084 00BA 0020 00FF 00FE 0092 0060 00DD 0004 0002 0001 0001 001C 0025
            else if(Rx_Buff[9] == 0x02) //BTN-2, 4
              {
            ...
            else if(Rx_Buff[9] == 0x03) //BTN-5, 7
              {
                 if(Rx_Buff[10] == 0x01)
                 {
            ...
            else if(Rx_Buff[9] == 0x04) //BTN-6, 8
              {
                 if(Rx_Buff[10] == 0x01)
                 {
                    // ledState31 = !ledState31;
...
void Switch_Counter_Handler()
{
  ...
  set_proximity_level();
  // Conversion to 4PB ASTRID
  if(active_button == 1 || active_button == 3)
    {
      active_button = 1;

    }
  else if(active_button == 2 || active_button == 4)
    {
      active_button = 2;

    }
  else if(active_button == 5 || active_button == 7)
    {
      active_button = 3;

    }
  else if(active_button == 6 || active_button == 8)
    {
      active_button = 4;

    }
//  else if(active_button == 5 || active_button == 6 || active_button == 7 || active_button == 8)
//    {
//      active_button = 2;
//
//    }
  ...
  //    emberEventControlSetActive(closeNetworkEventControl);
    ...
    else if (active_button == 1 || active_button == 50 || active_button == 70)
    {
        ...
        else if (active_button == 50 || active_button == 70) // 50 indicates button long hold action
        {
...
//        set_led(3, led1State);
    ...
    else if(active_button == 2 || active_button == 60 || active_button == 80)
      {
        ...
        else if(active_button == 60 || active_button == 80)
          {
            emberAfCorePrintln("---> Button %d Long Held\n", 2);
           // ledState2Long = !ledState2Long;
...
//        set_led(4, led2State);
    ...
    else if(active_button == 3 || active_button == 90 || active_button == 110)
      {
...
//        set_led(7, led3State);
    ...
    else if(active_button == 4 || active_button == 100 || active_button == 120)
      {
