...
#define EM_AF_GENERATED_NETWORK_STRINGS  \
  "Primary (pro)", \
/**** ZCL Section ****/
#define ZA_PROMPT "RS485_4PB_ASTRID"
...
#define ZCL_USING_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_SERVER
/**** Optional Attributes ****/
#define ZCL_USING_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_BOOT_COUNT_ATTRIBUTE 
#define ZCL_USING_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_C4_LED_1_ATTRIBUTE 
#define ZCL_USING_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_C4_LED_2_ATTRIBUTE 
#define ZCL_USING_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_C4_LED_3_ATTRIBUTE 
#define ZCL_USING_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_C4_LED_4_ATTRIBUTE 
#define ZCL_USING_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_C4_LED_5_ATTRIBUTE 
#define ZCL_USING_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_C4_LED_6_ATTRIBUTE 
#define ZCL_USING_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_C4_LED_7_ATTRIBUTE 
#define ZCL_USING_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_C4_LED_8_ATTRIBUTE 
#define ZCL_USING_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_C4_BUTTON_1_ATTRIBUTE 
#define ZCL_USING_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_C4_BUTTON_2_ATTRIBUTE 
#define ZCL_USING_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_C4_BUTTON_3_ATTRIBUTE 
#define ZCL_USING_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_C4_BUTTON_4_ATTRIBUTE 
#define ZCL_USING_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_C4_BUTTON_5_ATTRIBUTE 
#define ZCL_USING_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_C4_BUTTON_6_ATTRIBUTE 
#define ZCL_USING_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_C4_BUTTON_7_ATTRIBUTE 
#define ZCL_USING_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_C4_BUTTON_8_ATTRIBUTE 
#define ZCL_USING_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_C4_LED_1_STATE_ATTRIBUTE 
#define ZCL_USING_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_C4_LED_2_STATE_ATTRIBUTE 
#define ZCL_USING_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_C4_LED_3_STATE_ATTRIBUTE 
#define ZCL_USING_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_C4_LED_4_STATE_ATTRIBUTE 
#define ZCL_USING_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_C4_LED_5_STATE_ATTRIBUTE 
#define ZCL_USING_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_C4_LED_6_STATE_ATTRIBUTE 
#define ZCL_USING_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_C4_LED_7_STATE_ATTRIBUTE 
#define ZCL_USING_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_C4_LED_8_STATE_ATTRIBUTE 
#define ZCL_USING_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_C4_LED_DIM_UP_RATE_ATTRIBUTE 
#define ZCL_USING_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_C4_LED_DIM_DOWN_RATE_ATTRIBUTE 
#define ZCL_USING_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_C4_LED_DIM_MIN_ATTRIBUTE 
#define ZCL_USING_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_C4_LED_DIM_MAX_ATTRIBUTE 
#define ZCL_USING_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_C4_LED_ON_TIME_ATTRIBUTE 
...
#define EMBER_AF_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_SERVER_ENDPOINT_COUNT (1)
...
#define EMBER_CALLBACK_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_COMMAND_ONE
#define EMBER_CALLBACK_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_SERVER_MANUFACTURER_SPECIFIC_ATTRIBUTE_CHANGED
#define EMBER_CALLBACK_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_SERVER_MANUFACTURER_SPECIFIC_ATTRIBUTE_CHANGED
#define EMBER_CALLBACK_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_CUSTOM_END_DEVICE_CONFIGURATION_CLUSTER_SERVER_MANUFACTURER_SPECIFIC_ATTRIBUTE_CHANGED
...
#define EMBER_AF_PLUGIN_NETWORK_STEERING_TRY_ALL_KEYS
...
#define EMBER_AF_PLUGIN_OTA_CLIENT_POLICY_IMAGE_TYPE_ID 5
...
#define EMBER_AF_PLUGIN_OTA_STORAGE_SIMPLE_EEPROM_STORAGE_END 999424
...
#define EMBER_AF_API_ADC_CORTEXM3 "../../../../../SiliconLabs/SimplicityStudio/v5/developer/sdks/gecko_sdk_suite/v3.2/platform/base/hal/plugin/adc/adc-cortexm3.h"

// API adc from ADC plugin
#define EMBER_AF_API_ADC "../../../../../SiliconLabs/SimplicityStudio/v5/developer/sdks/gecko_sdk_suite/v3.2/platform/base/hal/plugin/adc/adc.h"

// API aes-cmac from AES-CMAC plugin
#define EMBER_AF_API_AES_CMAC "../../../../../SiliconLabs/SimplicityStudio/v5/developer/sdks/gecko_sdk_suite/v3.2/protocol/zigbee/app/framework/plugin/aes-cmac/aes-cmac.h"
...
#define EMBER_AF_API_EEPROM "../../../../../SiliconLabs/SimplicityStudio/v5/developer/sdks/gecko_sdk_suite/v3.2/util/plugin/plugin-common/eeprom/eeprom.h"

// API find-and-bind-target from Find and Bind Target plugin
#define EMBER_AF_API_FIND_AND_BIND_TARGET "../../../../../SiliconLabs/SimplicityStudio/v5/developer/sdks/gecko_sdk_suite/v3.2/protocol/zigbee/app/framework/plugin/find-and-bind-target/find-and-bind-target.h"

// API network-creator from Network Creator plugin
#define EMBER_AF_API_NETWORK_CREATOR "../../../../../SiliconLabs/SimplicityStudio/v5/developer/sdks/gecko_sdk_suite/v3.2/protocol/zigbee/app/framework/plugin/network-creator/network-creator.h"

// API network-creator-security from Network Creator Security plugin
#define EMBER_AF_API_NETWORK_CREATOR_SECURITY "../../../../../SiliconLabs/SimplicityStudio/v5/developer/sdks/gecko_sdk_suite/v3.2/protocol/zigbee/app/framework/plugin/network-creator-security/network-creator-security.h"
...
#define EMBER_AF_API_NVM3 "../../../../../SiliconLabs/SimplicityStudio/v5/developer/sdks/gecko_sdk_suite/v3.2/platform/base/hal/plugin/nvm3/nvm3-token.h"
