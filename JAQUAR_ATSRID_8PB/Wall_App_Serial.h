...
#define RS485_ENABLE_PORT gpioPortF
...
extern void led_inc_toggle_CB();
//extern void make_rs485_low_CB();
void modbus_send_twice_CB();
extern uint8_t button_pressed_num ; // Global variable to track button presses
extern SSwTimer led_inc_toggle;
extern SSwTimer timeout_config_addr;
//extern SSwTimer make_rs485_low;
extern SSwTimer modbus_send_twice;
extern bool addr_config_mode, enable_addr_mode;
extern uint8_t defined_keypadID;
