...
uint8_t MCP23017_2_ReadInput_PinA(uint8_t pin)
{
...
void MCP23017_2_Init()
{
    ...
    // Configure PORT A as Inputs for A7 & A6
    MCP23017_2_writeReg(MCP23017_PUR_A, 0xC0);   // Enable pull-up on A7,A6
    MCP23017_2_writeReg(MCP23017_DDR_A, 0xFF);   // All pins input (safe)

    // Local values reset to 0
